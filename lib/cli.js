...
const { createGeneralPaths } = require('./setup')
...
async function commandCut( rebarProjectJSON, argv ){
  ...
  try {
    ...
    const { repositoryName, repositoryShortName, repositoryUrl } = applicationDefinition
...
/*
const { cutVersion } = require('./lib/cut-version')
