...
module.exports.cutVersion = async (cwd, repositoryName, repositoryUrl) => {
  ...
  await createReleaseBranch(cwd, repositoryName, repositoryRevision)
  ...
  console.log('  ./update-' + repositoryName + ' ' + repositoryRevisionString)
  console.log('\n')
  console.log('💡  To release after testing:\n')
  console.log('  ./publish-' + repositoryName + ' ' + repositoryRevisionString)
  console.log('\n')
}
